...
use App\Filament\Admin\Pages\Auth\Register as AdminAuthRegister;
use App\Http\Middleware\FillamentAuthAdmin;
...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->path('admin')
            ->login()
            ->registration(AdminAuthRegister::class)
            ->colors([
                'primary' => Color::Amber,
            ])
